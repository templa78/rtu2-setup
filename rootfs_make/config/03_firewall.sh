...
-A INPUT -s 43.200.249.199/32 -p udp -m udp --dport 51820 -j ACCEPT
...
-A INPUT -s 10.176.72.208/28 -i usb0 -p tcp -m tcp --dport 8022 -j ACCEPT
-A INPUT -s 10.176.72.208/28 -i usb0 -p tcp -m tcp --dport 8443 -j ACCEPT
-A OUTPUT -d 43.200.249.199/32 -p udp -m udp --dport 51820 -j ACCEPT
-A OUTPUT -d 8.8.8.8/32 -p udp -m udp --dport 53 -j ACCEPT
-A OUTPUT -d 8.8.8.8/32 -p tcp -m udp --dport 53 -j ACCEPT
-A OUTPUT -d 168.126.63.1/32 -p udp -m udp --dport 53 -j ACCEPT
-A OUTPUT -d 168.126.63.1/32 -p tcp -m udp --dport 53 -j ACCEPT
...
###### INPUT #####
# VPN
-A INPUT -p udp -s 43.200.249.199 --dport 51820 -j ACCEPT
...
-A INPUT -i usb0 -p tcp -s 10.176.72.208/28 --dport 8022 -j ACCEPT
-A INPUT -i usb0 -p tcp -s 10.176.72.208/28 --dport 8443 -j ACCEPT


###### OUTPUT #####
# VPN
-A OUTPUT -p udp -d 43.200.249.199 --dport 51820 -j ACCEPT
...
-A OUTPUT -p tcp -d 168.126.63.1 --dport 53 -j ACCEPT
