...
cryptsetup luksFormat --batch-mode --type luks2 ${TARGET_PART2} --key-file ../data/lm.bin
sleep 1

# 자체 키 등록
g3k_util read 50 | cryptsetup luksAddKey --key-file=../data/lm.bin ${TARGET_PART2} --new-keyfile=-
sleep 1
